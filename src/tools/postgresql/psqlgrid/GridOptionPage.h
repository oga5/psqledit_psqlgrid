...
// ダイアログ データ
	...
	BOOL	m_show_space;
	BOOL	m_adjust_col_width_no_use_colname;
	BOOL	m_invert_select_text;
	BOOL	m_show_line_feed;
	BOOL	m_show_tab;
	BOOL	m_copy_escape_dblquote;
	BOOL	m_ime_caret_color;
	BOOL	m_end_key_like_excel;
	CString	m_null_text;
	//}}AFX_DATA
...
protected:
	...
	afx_msg void OnCheckAdjustColWidthNoUseColname();
	afx_msg void OnCheckInvertSelectText();
	afx_msg void OnCheckShowTab();
	afx_msg void OnCheckShowLineFeed();
	afx_msg void OnCheckEndKeyLikeExcel();
	afx_msg void OnChangeEditNullText();
	//}}AFX_MSG
...
public:
	...
	afx_msg void OnEnChangeEditCellPaddingTop();

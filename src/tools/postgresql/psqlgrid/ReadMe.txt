========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : psqlgrid
========================================================================


AppWizard が生成した psqlgrid には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには psqlgrid を構成している各ファイルの概要説明が含まれています。
...
psqlgrid.h
    ...
    みます） をインクルードし、また CPsqlgridApp アプリケーションクラスを宣
    言します。

psqlgrid.cpp
    このファイルは CPsqlgridApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\psqlgrid.ico
    ...
    ルです。このアイコンはリソース ファイル psqlgrid.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、psqlgrid.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

psqlgridDoc.h, psqlgridDoc.cpp - ドキュメント
    これらのファイルは CPsqlgridDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CPsqlgridDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

psqlgridView.h, psqlgridView.cpp - ビュー
    これらのファイルは CPsqlgridView クラスを含みます。
    CPsqlgridView オブジェクトは CPsqlgridDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) psqlgrid.pch 

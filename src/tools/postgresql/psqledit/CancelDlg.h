...
/////////////////////////////////////////////////////////////////////////////
// CCancelDlg ダイアログ
#define WM_CANCEL_DLG_BASE	WM_APP + 8000

#define	WM_UPDATE_ALL_VIEWS	WM_CANCEL_DLG_BASE + 200
#define WM_DISP_BIND_PARAM_EDITOR	WM_CANCEL_DLG_BASE + 201
...
private:
	int BindParams();
	void SetMsg(const TCHAR* msg, int idx);

	UINT_PTR		m_disp_timer;
	DWORD			m_tick_count_total;
public:
	CString m_static2;
};
